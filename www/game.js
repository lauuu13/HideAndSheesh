...
function buildFloor(floorIndex) {
  ...
  if (floorIndex === 0) {
    ...
    wallBox(0.4, 2, 2, 0x5c3d2e, 1.5, 1, -2); // bookshelf
    ...
    wallBox(1.4, 1, 0.6, 0x8a6c4a, -2, baseY + 0.5, -5); // dresser
    wallBox(1, 0.9, 0.8, 0x8a6c4a, -7, baseY + 0.45, -6); // nightstand
    wallBox(0.5, 1.6, 0.5, 0x2f6f4f, -8, baseY + 0.8, -3); // floor plant
    wallBox(0.6, 2.2, 2, 0x5c3d2e, 1.5, baseY + 1.1, -2); // closet

    // --- Bedroom 2 (front-right) ---
    signPlane(2.2, 0.6, 12, baseY + 3.6, HOUSE_Z_MIN + 0.05, TEX.signBed2, 0);
    buildBed(12, -9, 0xf4a261, baseY);
    wallBox(1.6, 0.8, 0.7, 0x8a6c4a, 15, baseY + 0.4, -3); // desk
    wallBox(0.4, 2, 2, 0x5c3d2e, 15.5, baseY + 1, -8); // bookshelf
    ...
    wallBox(1.6, 0.5, 0.7, 0x2b2b2b, 9, baseY + 0.25, -10); // weight bench
    wallBox(0.6, 1.6, 0.6, 0x495057, 12, baseY + 0.8, -10); // weight rack
